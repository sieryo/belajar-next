      ...
      <div className="lg:flex-row   relative items-center flex-col flex justify-between">
        ...
        <div className="w-[500px] flex flex-col lg:pt-0 pt-[100px] items-center z-20 lg:pr-[200px] h-[500px] ">
          ...
          <div>
            ...
            <div className="flex gap-10 lg:pt-6 pt-11 justify-center relative uppercase">
              <div className="group relative">
                <div className="absolute top-[-55px] left-[-50px] w-[200px] ">
                  <CanvasTest />
                </div>
                <ButtonMap color="zinc" title="Lihat lebih" />
              </div>
              <div className=" group relative">
                <div className="absolute top-[-55px] left-[-50px] w-[200px]">
                  <CanvasTest />
                </div>
                <ButtonMap color="zinc" title="Pelajari" />
              </div>
            </div>
          </div>
        </div>
